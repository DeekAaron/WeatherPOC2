...
/// (transport, non-200, error:true body, malformed/missing field) into this — fail-visible,
/// always after logging. The message is diagnostic (logged), never shown to the user verbatim.
/// </summary>
